...
Elm.Component.Autobiography = Elm.Component.Autobiography || {};
Elm.Component.Autobiography.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.Autobiography = _elm.Component.Autobiography || {};
   if (_elm.Component.Autobiography.values)
   return _elm.Component.Autobiography.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var options = _U.update($Markdown.defaultOptions,
   {smartypants: true});
   var content = A2($Markdown.toHtmlWith,
   options,
   ...
   var autobiography = A2($Html.div,
   _U.list([$Html$Attributes.$class("Autobiography")]),
   _U.list([content]));
   return _elm.Component.Autobiography.values = {_op: _op
                                                ,autobiography: autobiography
                                                ,options: options
                                                ,content: content};
};
Elm.Component = Elm.Component || {};
Elm.Component.Letter = Elm.Component.Letter || {};
Elm.Component.Letter.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.Letter = _elm.Component.Letter || {};
   if (_elm.Component.Letter.values)
   return _elm.Component.Letter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var letter = A2($Html.div,
   _U.list([$Html$Attributes.$class("Letter")]),
   _U.list([content]));
   return _elm.Component.Letter.values = {_op: _op
                                         ,letter: letter
                                         ,options: options
                                         ,content: content};
};
Elm.Component = Elm.Component || {};
Elm.Component.Obituary = Elm.Component.Obituary || {};
Elm.Component.Obituary.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.Obituary = _elm.Component.Obituary || {};
   if (_elm.Component.Obituary.values)
   return _elm.Component.Obituary.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var obituary = A2($Html.div,
   _U.list([$Html$Attributes.$class("Obituary")]),
   _U.list([content]));
   return _elm.Component.Obituary.values = {_op: _op
                                           ,obituary: obituary
                                           ,options: options
                                           ,content: content};
};
...
Elm.Main.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Autobiography = Elm.Component.Autobiography.make(_elm),
   $Component$Letter = Elm.Component.Letter.make(_elm),
   $Component$Obituary = Elm.Component.Obituary.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   _U.list([]),
   _U.list([$Component$Letter.letter
           ,$Component$Autobiography.autobiography
           ,$Component$Obituary.obituary]));
   var main = view;
