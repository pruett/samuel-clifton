...
Elm.Autobiography = Elm.Autobiography || {};
Elm.Autobiography.make = function (_elm) {
   "use strict";
   _elm.Autobiography = _elm.Autobiography || {};
   if (_elm.Autobiography.values) return _elm.Autobiography.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   _U.list([content]));
   return _elm.Autobiography.values = {_op: _op
                                      ,autobiography: autobiography};
};
Elm.Obituary = Elm.Obituary || {};
Elm.Obituary.make = function (_elm) {
   "use strict";
   _elm.Obituary = _elm.Obituary || {};
   if (_elm.Obituary.values) return _elm.Obituary.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   _U.list([content]));
   return _elm.Obituary.values = {_op: _op,obituary: obituary};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Autobiography = Elm.Autobiography.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Obituary = Elm.Obituary.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = A2($Html.div,
   _U.list([]),
   _U.list([$Autobiography.autobiography,$Obituary.obituary]));
